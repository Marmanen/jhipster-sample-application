package fi.easer.myapp.web.rest;

import static fi.easer.myapp.web.rest.AccountResourceIT.TEST_USER_LOGIN;
...
import fi.easer.myapp.JhipsterSampleApplicationApp;
import fi.easer.myapp.config.Constants;
import fi.easer.myapp.domain.Authority;
import fi.easer.myapp.domain.PersistentToken;
import fi.easer.myapp.domain.User;
import fi.easer.myapp.repository.AuthorityRepository;
import fi.easer.myapp.repository.PersistentTokenRepository;
import fi.easer.myapp.repository.UserRepository;
import fi.easer.myapp.security.AuthoritiesConstants;
import fi.easer.myapp.service.UserService;
import fi.easer.myapp.service.dto.PasswordChangeDTO;
import fi.easer.myapp.service.dto.UserDTO;
import fi.easer.myapp.web.rest.vm.KeyAndPasswordVM;
import fi.easer.myapp.web.rest.vm.ManagedUserVM;
