...
import fi.easer.myapp.config.audit.AuditEventConverter;
import fi.easer.myapp.domain.PersistentAuditEvent;
import fi.easer.myapp.repository.PersistenceAuditEventRepository;
import fi.easer.myapp.security.AuthoritiesConstants;
import fi.easer.myapp.service.AuditEventService;
